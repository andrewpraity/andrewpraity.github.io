...
// Fungsi untuk menampilkan komentar
    function tampilkanKomentar() {
        fetch('https://api.github.com/repos/andrewpraity/andrewpraity.github.io/issues', {
            method: 'GET',
            headers: {
                'Authorization': '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'
            }
        })
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            fetch('https://api.github.com/repos/andrewpraity/andrewpraity.github.io/issues', {
                method: 'POST',
                headers: {
                    'Authorization': 'token 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',

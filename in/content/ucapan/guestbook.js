document.addEventListener("DOMContentLoaded", function () {
    ...
    document.body.innerHTML = ucapan; // Mengganti konten body dengan kode HTML
    ...
    form.addEventListener("submit", function(event) {
        ...
        fetch('https://api.github.com/repos/andrewpraity/andrewpraity.github.io/issues', {
            method: 'POST',
            headers: {
                'Authorization': 'token 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',
...
function tampilkanKomentar() {
    fetch('https://api.github.com/repos/andrewpraity/andrewpraity.github.io/issues', {
        method: 'GET',
        headers: {
            'Authorization': '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'
        }
    })
    .then(response => response.json())
    .then(data => {
                ...
                <section class="post-container">
                    ...
                    <div class="post-wrap">
                        <div class="post-item">
                            ...
                            <h6 class="post-status item"><span class="${komentarData.kehadiran.toLowerCase()}">${komentarData.kehadiran}</span></h6>
                        </div>

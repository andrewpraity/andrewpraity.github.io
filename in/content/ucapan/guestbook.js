...
// Fungsi untuk menampilkan komentar
    function tampilkanKomentar() {
        fetch('https://api.github.com/repos/andrewpraity/andrewpraity.github.io/issues', {
            method: 'GET',
            headers: {
                'Authorization': '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'
            }
        })
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(event) {
            ...
            fetch('https://api.github.com/repos/andrewpraity/andrewpraity.github.io/issues', {
                method: 'POST',
                headers: {
                    'Authorization': 'token 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',
